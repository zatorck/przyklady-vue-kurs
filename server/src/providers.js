...
export async function initData () {
  ...
  Questions.insert([
    ...
    {
      title: 'Dlaczego moje zamówienie zostało anulowane?',
    ...
    {
      title: 'Dlaczego mój kod rabatowy nie działa?',
